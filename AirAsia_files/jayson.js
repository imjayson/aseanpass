...
var createCol = function(loc) {
    var $locs = $('<div style="width: 100px;float: left;" class="loc"></div>');
...
var createLink = function(text, credits) {
    return $('<div onclick="highlight(this);updateCredits();createCol(this.innerHTML);" loc-id="'+text+'" credits="'+credits+'">' + text + '</div>');
}
